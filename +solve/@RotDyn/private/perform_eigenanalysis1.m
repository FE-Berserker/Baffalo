function [V,D] = perform_eigenanalysis1(mat,n_ew)
...
num.modes_local = n_ew + 4; % +4 damit bei stark gedaempften EW immer noch genug EW berechnet werden sodass eine Mindestanzhal an forward und backward-Moden gefunden werden kann
while criteria
