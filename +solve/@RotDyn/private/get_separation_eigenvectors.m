function [ EV_for,EW_for,EV_back,EW_back,EV_0,EW_0, Phase_xy, Phase_xy_mean ] = get_separation_eigenvectors(EV_raw,EW_raw,nmodes)
...
EV_for = EV_for(:,1:nmodes/2);
EW_for = EW_for(1:nmodes/2);

EV_back = EV_back(:,1:nmodes/2);
EW_back = EW_back(1:nmodes/2);
