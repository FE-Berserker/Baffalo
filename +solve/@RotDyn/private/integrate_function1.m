function dZ = integrate_function1(t,Z,rpm_span,t_span, rotorsystem,load)
...
[M,C,G,K] = assemble_system_matrices(rotorsystem,rpm_curr); % Systemmatrizen sind in jedem Zeitschritt anders wegen Seal und Bearing rpm-abhaengig
D = C + Omega_curr*G;
