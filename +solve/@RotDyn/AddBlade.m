function obj= AddBlade(obj,NodeNum,Surface2D,MatNum,BladeNum,Degree)
% Add Blade to Shaft
% Author : Xie Yu
...
mm=Revolve2Solid(mm,m,'Slice',RotNum,'Degree',Degree);
L=obj.output.Shape;
Temp_Position=Position;
Temp_Position(1,1)=obj.input.Shaft.Meshoutput.nodes(NodeNum,1);
for i=1:BladeNum
    Temp_Position(1,4)=360/BladeNum*(i-1);
