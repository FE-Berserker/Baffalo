...
if abs(dis(row,1))<=opt.Dtol
    ...
    if dis(row,1)<0
        ...
        obj.input.MaterialNum=[obj.input.MaterialNum(1:row-1,1);obj.input.MaterialNum(row,1);obj.input.MaterialNum(row:end,1)];
        NodeNum=row+1;
        ...
        obj.input.Shaft.Section=NewSection;
        obj.input.MaterialNum=[obj.input.MaterialNum(1:row-1,1);obj.input.MaterialNum(row-1,1);obj.input.MaterialNum(row:end,1)];
        NodeNum=row;
        obj=Update(obj,NodeNum);
    end
