...
for i=1:size(opt.rpm,1)
    ...
    if ~isempty(Node)
        for j = 1:size(Node,1)
            ...
            struct(i).data(acc).X = currDataset.X(Node(j,1)*6-3,:);
            struct(i).data(acc).Y = currDataset.X(Node(j,1)*6-5,:);
            struct(i).data(acc).Z = currDataset.X(Node(j,1)*6-4,:);
            ...
            struct(i).data(acc).Node = Node(j,1);
            struct(i).data(acc).X = currDataset.X_d(Node(j,1)*6-3,:);
            struct(i).data(acc).Y = currDataset.X_d(Node(j,1)*6-5,:);
            struct(i).data(acc).Z = currDataset.X_d(Node(j,1)*6-4,:);
            ...
            struct(i).data(acc).Node = Node(j,1);
            struct(i).data(acc).X = currDataset.X_dd(Node(j,1)*6-3,:);
            struct(i).data(acc).Y = currDataset.X_dd(Node(j,1)*6-5,:);
            struct(i).data(acc).Z = currDataset.X_dd(Node(j,1)*6-4,:);
