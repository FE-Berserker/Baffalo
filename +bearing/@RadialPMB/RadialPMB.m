classdef RadialPMB < Component
    ...
    properties(Hidden, Constant)
        ...
        outputExpectedFields = {
            ...
            'Stiffness' % Stiffness curve of bearing 
            };

        baselineExpectedFields = {
            };

        default_Name='RadialPMB_1'; % Set default params name
    ...
    methods
        ...
        function obj = RadialPMB(paramsStruct,inputStruct,varargin)
            obj = obj@Component(paramsStruct,inputStruct,varargin);
            obj.documentname='RadialPMB.pdf'; % Set help file name, put it in the folder "Document"
        end
