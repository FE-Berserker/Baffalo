...
% not. So this demo's resolution better.
% 制作标准偏移合成数据。这是一个恒定速度2D合成剖面，用于演示偏移效果。
% 该数据使用双曲线叠加，而 MAKESTDSYN 不使用。因此此演示的分辨率更好。 Ths synthetic includes four right-dipping events with dips
