...
addParameter(p,'kernel','normal')
addParameter(p,'npoints',100)
addParameter(p,'extra_y',0)
addParameter(p,'normalization','area') %'count' 'width'
addParameter(p,'fill','face')
addParameter(p,'width',0.6)
addParameter(p,'dodge',0.7)
addParameter(p,'half',false)
parse(p,varargin{:});
...
function hndl=my_violin(obj,draw_data,params) %#ok<STOUT> 
