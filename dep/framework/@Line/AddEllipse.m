function obj=AddEllipse(obj,a,b,Point,P,varargin)
...
ang  = opt.ang;
eang=sang+ang;
c0 = nrbcirc(a,[0,0,0],sang/180*pi,eang/180*pi) ;
Matrix = vectrans(Point.PP{P,1})*vecrotx(opt.rot(3)/180*pi)...
    *vecroty(opt.rot(2)/180*pi)*vecrotx(opt.rot(1)/180*pi)...
    *vecscale([1,b/a]); 
