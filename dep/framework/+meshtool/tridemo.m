...
%------------------------------------------- call mesh-gen.
   [vert,etri, ...
    tria,tnum] = meshtool.refine2(node,edge) ;
...
%------------------------------------------- call mesh-gen.
   ...
   [vert,etri, ...
    tria,tnum] = meshtool.refine2(node,edge,[],[],hfun) ;
...
%lity.
   ...
   [node,edge] = meshtool.triread( meshfile );
...
' sparse triangulations with poor worst-case angle bounds. \n', ...
   ...
   [vert,etri, ...
    tria,tnum] = meshtool.refine2(node,edge,[]  ,opts) ;
...
%---------------------------------------------- do mesh-opt.
   [vnew,enew, ...
    tnew,tnum] = meshtool.smooth2(vert,etri,tria,tnum) ;
    ...
    meshtool.tricost(vert,etri,tria,tnum,hvrt) ;
    meshtool.tricost(vnew,enew,tnew,tnum,hnew) ;
...
%---------------------------------------------- do mesh-gen.
   ...
   [vert,etri, ...
    tria,tnum] = meshtool.refine2(node,edge,part,  [], ...
                         hfun, ...
                         vlfs,tlfs,slfs,hlfs) ;

%---------------------------------------------- do mesh-opt.
   [vert,etri, ...
    tria,tnum] = meshtool.smooth2(vert,etri,tria,tnum) ;
    ...
    meshtool.tricost(vert,etri,tria,tnum);
...
%---------------------------------------------- do mesh-gen.
   ...
   [vert,etri, ...
    tria,tnum] = meshtool.refine2(node,edge,part,opts, ...
                         hmax) ;
...
%---------------------------------------------- do mesh-opt.
   ...
   [vnew,enew, ...
    tnew,tnum] = meshtool.smooth2(vnew,enew,tnew,tnum) ;
    ...
    meshtool.tricost(vert,etri,tria,tnum);
    meshtool.tricost(vnew,enew,tnew,tnum);
