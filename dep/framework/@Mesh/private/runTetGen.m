...
pathNameTetGen=fullfile(fileparts(fileparts(mfilename('fullpath'))),'tetGen');
pathNameTempFiles=fullfile(fileparts(fileparts(mfilename('fullpath'))),'private','data','temp');
